define(["./udaan-app.js","./ajax-call.js"],function(_udaanApp,_ajaxCall){"use strict";class DonationDetails extends _udaanApp.PolymerElement{static get template(){return _udaanApp.html`
<style>
:host {
    display: block;
    padding:0px;
