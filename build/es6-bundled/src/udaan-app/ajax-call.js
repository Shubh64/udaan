define(["./udaan-app.js"],function(_udaanApp){"use strict";(0,_udaanApp.Polymer)({is:"iron-request",hostAttributes:{hidden:!0/* ignoreName */ /* skipSlots */},properties:{/**
...
if(null===str||str===void 0||!str.toString){return""}return encodeURIComponent(str.toString().replace(/\r?\n/g,"\r\n")).replace(/%20/g,"+")},/**
   ...
   */_updateStatus:function(){this._setStatus(this.xhr.status);this._setStatusText(this.xhr.statusText===void 0?"":this.xhr.statusText)}});(0,_udaanApp.Polymer)({is:"iron-ajax",/**
