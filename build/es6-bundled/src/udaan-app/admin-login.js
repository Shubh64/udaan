define(["./udaan-app.js","./ajax-call.js"],function(_udaanApp,_ajaxCall){"use strict";class AdminLogin extends _udaanApp.PolymerElement{static get template(){return _udaanApp.html`
      <style>
        :host {
          display: block;
