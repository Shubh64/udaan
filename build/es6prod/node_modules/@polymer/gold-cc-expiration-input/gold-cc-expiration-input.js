define(["../polymer/polymer-legacy.js","../paper-input/paper-input-container.js","../paper-input/paper-input-error.js","../iron-input/iron-input.js","./date-input.js","../iron-form-element-behavior/iron-form-element-behavior.js","../paper-input/paper-input-behavior.js","../polymer/lib/legacy/polymer-fn.js","../polymer/lib/utils/html-tag.js"],function(_polymerLegacy,_paperInputContainer,_paperInputError,_ironInput,_dateInput,_ironFormElementBehavior,_paperInputBehavior,_polymerFn,_htmlTag){"use strict";/**
@license
...
*/(0,_polymerFn.Polymer)({_template:_htmlTag.html`
  ...
  `,is:"gold-cc-expiration-input",/* The underlying dateInput is tabbable */hostAttributes:{tabindex:-1},behaviors:[_paperInputBehavior.PaperInputBehavior,_ironFormElementBehavior.IronFormElementBehavior],properties:{/**
...
// Polymer 1
this.__ignoreAutoValidation=!0/* ignoreName */ /* skipSlots */},/**
...
return value.split("/")[1]||""},/**
   ...
   */_onFocusedChanged:function(focused){if(this.__ignoreAutoValidation){this.__ignoreAutoValidation=/* ignoreName */!1/* skipSlots */ /* skipSlots */;return}if(!focused){this._handleAutoValidate()}}})});