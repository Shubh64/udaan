...
`,is:"app-drawer-layout",behaviors:[_appLayoutBehavior.AppLayoutBehavior],properties:{/**
     ...
     */forceNarrow:{type:Boolean,value:/* ignoreName */ /* ignoreName */!1/* skipSlots */ /* skipSlots */},/**
     ...
     */narrow:{type:Boolean,reflectToAttribute:!0/* skipSlots */,readOnly:!0,notify:!0},/**
   ...
   *
   * @property drawer
   */get drawer(){return(0,_polymerDom.dom)(this.$.drawerSlot).getDistributedNodes()[0]},/** @override */attached:function(){// Disable drawer transitions until after app-drawer-layout sets the initial
// opened state.
