define(["exports","../polymer/polymer-legacy.js","../polymer/lib/legacy/polymer.dom.js"],function(_exports,_polymerLegacy,_polymerDom){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.IronScrollTargetBehavior=void 0;/**
@license
 ...
 */const IronScrollTargetBehavior={properties:{/**
   ...
   */_shouldHaveListener:!0,_scrollTargetChanged:function(scrollTarget,isAttached){var eventTarget;if(this._oldScrollTarget){this._toggleScrollListener(/* ignoreName */!1/* skipSlots */ /* skipSlots */,this._oldScrollTarget);this._oldScrollTarget=null}if(!isAttached){return}// Support element id references
