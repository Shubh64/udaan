define(["meta","../polymer/polymer-legacy.js","../paper-input/paper-input-container.js","../paper-input/paper-input-error.js","../iron-input/iron-input.js","../iron-icon/iron-icon.js","../iron-flex-layout/iron-flex-layout.js","../iron-form-element-behavior/iron-form-element-behavior.js","../paper-input/paper-input-behavior.js","../polymer/lib/legacy/polymer-fn.js","../polymer/lib/utils/html-tag.js"],function(meta,_polymerLegacy,_paperInputContainer,_paperInputError,_ironInput,_ironIcon,_ironFlexLayout,_ironFormElementBehavior,_paperInputBehavior,_polymerFn,_htmlTag){"use strict";meta=babelHelpers.interopRequireWildcard(meta);/**
@license
...
*/(0,_polymerFn.Polymer)({_template:_htmlTag.html`
  ...
  `,is:"gold-cc-cvc-input",importMeta:meta,properties:{/**
     * The label for this input.
     */label:{type:String,value:"CVC"},/**
     * The type of card that the CVC is for.
     */cardType:{type:String,value:""},_requiredLength:{type:Number,computed:"_computeRequiredLength(cardType)"},_amex:{type:Boolean,computed:"_computeIsAmex(cardType)"},value:{type:String,observer:"_onValueChanged"}},behaviors:[_paperInputBehavior.PaperInputBehavior,_ironFormElementBehavior.IronFormElementBehavior],observers:["_onFocusedChanged(focused)"],ready:function(){if(!this.value){this.value=""}},/**
