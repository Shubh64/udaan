define(["./udaan-app.js"],function(_udaanApp){"use strict";function _templateObject_89f70a904f5311ea93b76d3367071c20(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n      </style>\n    <iron-ajax id=\"ajax\" on-response=\"_handleResponse\" on-error=\"_handleError\" handle-as=\"json\" content-type=\"application/json\"> </iron-ajax>\n    "]);_templateObject_89f70a904f5311ea93b76d3367071c20=function _templateObject_89f70a904f5311ea93b76d3367071c20(){return data};return data}(0,_udaanApp.Polymer)({is:"iron-request",hostAttributes:{hidden:!0/* ignoreName */ /* skipSlots */ /* ignoreName */ /* skipSlots */},properties:{/**
...
if(null===str||str===void 0||!str.toString){return""}return encodeURIComponent(str.toString().replace(/\r?\n/g,"\r\n")).replace(/%20/g,"+")},/**
   ...
   */_updateStatus:function _updateStatus(){this._setStatus(this.xhr.status);this._setStatusText(this.xhr.statusText===void 0?"":this.xhr.statusText)}});(0,_udaanApp.Polymer)({is:"iron-ajax",/**
...
switch(this.action){case"ajaxResponse":this.dispatchEvent(new CustomEvent("ajax-response",{bubbles:!0,composed:!0,detail:{data:data,loading:!0}}));break;default:}}},{key:"_handleError",value:function _handleError(event){//All the response has been handled through switch case by dispatching event details to the parent
var data=event.detail.request.response;console.log(data);switch(this.action){case"ajaxResponse":this.dispatchEvent(new CustomEvent("ajax-response",{bubbles:!0,composed:!0,detail:{data:data}}));break;}}}],[{key:"template",get:function get(){return(0,_udaanApp.html)(_templateObject_89f70a904f5311ea93b76d3367071c20())}},{key:"properties",get:function get(){return{}}}]);return AjaxCall}(_udaanApp.PolymerElement);window.customElements.define("ajax-call",AjaxCall)});